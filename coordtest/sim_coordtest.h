...
private:
	...
	const SimParameter cop{"CoP", 1.0, "temptation to choose defection"};
	const SimParameter crp{"CrP", 0.2, "reward for cooperation"};
	const SimParameter sep{"SoP", 0.005, "reward for cooperation"};
