...
Sim_socdil_lev_logit::Sim_socdil_lev_logit(size_t width) : Simulation(width), csok(width), nov(width), data2(width * width),
...
void Sim_socdil_lev_logit::reset()		/* creates a random strategy distribution across the whole grid */
{
