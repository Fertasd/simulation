...
class Sim_socdil_mix_imit: public Simulation
{
public:
	Sim_socdil_mix_imit(size_t width = 500);						/*UC: declares a simulation with given width */
	constexpr static auto name() { return "socdil_mixed_imit"; }
...
private:
	...
	const SimParameter T{"T", 1.69, "temptation to choose defection"};
	const SimParameter R{"R", 1.0, "reward for cooperation"};
